...
set(command "${make};EXTRA_CFLAGS=-Wno-error")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/jzc/rn2db/dash/build/pmdk/src/PMDK-stamp/PMDK-build-out.log")
set(stderr_log "/home/jzc/rn2db/dash/build/pmdk/src/PMDK-stamp/PMDK-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/jzc/rn2db/dash/build/pmdk/src/PMDK-stamp/PMDK-build-*.log")
  endif()
  ...
  set(msg "PMDK build command succeeded.  See also /home/jzc/rn2db/dash/build/pmdk/src/PMDK-stamp/PMDK-build-*.log")
  message(STATUS "${msg}")
endif()
